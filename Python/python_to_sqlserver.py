...
def to_sql(
    ...
    driver: string
        SQL Server driver name as installed in the server. Default: "SQL Server"
    trusted: string
        Is the connection secured? Default: "yes"
    ...
    Returns
    -------
    A table in SQL Server in the database and server spedified
    """
